...
#if defined __UNIX64__ || defined __LINUX64__ || defined POINTER_SIZE_64
...
typedef unsigned short                  texu_word;
typedef unsigned int                    texu_dword;
typedef unsigned long long              texu_qword;
