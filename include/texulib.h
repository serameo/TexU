...
texu_list_item *texu_list_find_first(texu_list *, texu_i64);
texu_list_item *texu_list_find_next(texu_list *, texu_list_item *, texu_i64);
/* reverse find a data in the list */
texu_list_item *texu_list_rfind_last(texu_list *, texu_i64);
texu_list_item *texu_list_rfind_prev(texu_list *, texu_list_item *, texu_i64);
...
texu_stack *texu_stack_new(texu_i64);
...
texu_status texu_stack_push(texu_stack *, texu_i64);
...
texu_tree_item *texu_tree_add_item(texu_tree *, texu_tree_item *, texu_i64);
...
#
*/
texu_i32 texu_map_strcmp(const void *, const void *);
texu_i32 texu_map_wstrcmp(const void *v1, const void *v2);
...
texu_status texu_map_cmp_insert(
    ...
    texu_i64,
    texu_i64,
    texu_i32 (*)(const void *, const void *));
/* remove */
