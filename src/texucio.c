...
#if (defined TEXU_CIO_COLOR_MONO || defined __USE_TTY__ || defined __VMS__ || defined __USE_TERMIOS__ || defined __USE_TERMBOX2__)
    /* draw upper left*/
