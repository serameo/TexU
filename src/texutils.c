...
texu_safedb_status texu_safedb_open_read(texu_safedb_ptr _db, texu_safedb_cstr _dbfile)
{
    return _texu_safedb_open(_db, _dbfile, SQLITE_OPEN_READONLY);
}
texu_safedb_status   texu_safedb_open2(texu_safedb_ptr _db, texu_safedb_cstr _dbfile, texu_safedb_ui32 _flags)
{
...
int texu_safedb_exec(texu_safedb_ptr _db, texu_safedb_cstr _sqlcmd, texu_safedb_exec_callback _callback, texu_safedb_userptr _userptr)
{
    int rc = 0;
    char *errmsg = 0;
    texu_safedb_errno = TEXU_SAFEDB_OK;
...
texu_safedb_sel_ptr  texu_safedb_select(texu_safedb_ptr _db, texu_safedb_cstr _sqlcmd, texu_safedb_copy_callback _callback, texu_safedb_ui32 _size)
{
    /*See sqlite doc*/
    sqlite3_stmt *stmt;
    int     rc      = 0; 
...
texu_safedb_rowptr texu_safedb_sel_get(texu_safedb_sel_ptr _selptr, texu_safedb_i32 _row)
{
...
texu_safedb_float texu_safedb_aggregate(texu_safedb_ptr _db, texu_safedb_cstr _sqlcmd)
{
    sqlite3_stmt *stmt;
...
texu_safedb_bool     texu_safedb_is_existing(texu_safedb_ptr _db, texu_safedb_cstr _tabname)
{
    /*see sqlite3 doc*/
    char  zSql[BUFSIZ];
